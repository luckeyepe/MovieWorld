...
import kotlinx.android.synthetic.main.fragment_coming_soon.view.*
...
class ComingSoonFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var query = db.whereEqualTo("movie_is_showing",false)
        var movieList = ArrayList<Movie>()
        var adapter = NowPlayingMovieAdapter(movieList, this?.context!!)


        view.recyclerView_comingSoonFragmentRecyclerView.layoutManager = LinearLayoutManager(context)
        view.recyclerView_comingSoonFragmentRecyclerView.adapter = adapter
